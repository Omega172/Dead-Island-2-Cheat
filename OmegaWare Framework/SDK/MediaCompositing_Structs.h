...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CQ1O[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_I91B[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
