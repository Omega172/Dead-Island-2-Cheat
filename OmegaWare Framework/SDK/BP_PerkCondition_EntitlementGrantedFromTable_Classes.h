...
namespace CG
{
	...
	public:
		...
		class UGameEntitlementsDataTable*                          EntitlementTableToCheck;                                 // 0x0068(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UBP_PerkCondition_EntitlementGrantedFromTable_Data_C* PerkConditionData;                                       // 0x0070(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
