...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LFPP[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FDialogueTriggerChooser                             DialogueToTriggerOnBegin;                                // 0x004C(0x0018) Edit, BlueprintVisible, NoDestructor
		unsigned char                                              UnknownData_MVMY[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
