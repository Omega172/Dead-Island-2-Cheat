...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_PerkCondition_OwnerHasKilledEnemy.BP_PerkCondition_OwnerHasKilledEnemy_C
	 * Size -> 0x0008 (FullSize[0x0068] - InheritedSize[0x0060])
	 */
	class UBP_PerkCondition_OwnerHasKilledEnemy_C : public UPerkCondition
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_PerkCondition_OwnerHasKilledEnemy(int32_t EntryPoint);
