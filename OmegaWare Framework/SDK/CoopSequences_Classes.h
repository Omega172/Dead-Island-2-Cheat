...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6XRU[0x10];                                  // 0x02C0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		class ACoopSequenceState* STATIC_GetWorldCoopSequenceState(class UObject* WorldContextObject);
		class ACoopSequenceState* STATIC_GetLocalPlayerCoopSequenceState(class UObject* WorldContextObject);
	...
	{
	public:
		unsigned char                                              UnknownData_7FQ9[0x8];                                   // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_09TX[0x48];                                  // 0x02D0(0x0048) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GXVJ[0x10];                                  // 0x00B0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2RLM[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
