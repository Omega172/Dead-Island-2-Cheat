...
namespace CG
{
	...
	/**
	 * Function BP_Action_Dead_AI.BP_Action_Dead_AI_C.OnEnd
	 */
	struct UBP_Action_Dead_AI_C_OnEnd_Params
	{
	public:
		struct FGuid                                               RequestId;                                               // 0x0000(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	public:
		...
		unsigned char                                              UnknownData_6PKI[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
