...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0UF4[0x5];                                   // 0x018B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WK2X[0x3];                                   // 0x01C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
