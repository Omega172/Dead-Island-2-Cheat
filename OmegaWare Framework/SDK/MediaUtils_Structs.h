...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_90TK[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_01ME[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (PADDING)
	};
