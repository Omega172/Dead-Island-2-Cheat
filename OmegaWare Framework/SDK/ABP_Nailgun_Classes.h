...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_Nailgun.ABP_Nailgun_C
	 * Size -> 0x0090 (FullSize[0x0C60] - InheritedSize[0x0BD0])
	 */
	class UABP_Nailgun_C : public UDIWeaponAnimInstance
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_ABP_Nailgun(int32_t EntryPoint);
