...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_5S5A[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		class FName                                                ClassName;                                               // 0x0038(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	};
	...
	public:
		...
		TMap<class FName, struct FGuid>                            BindNameMap;                                             // 0x00A0(0x0050) NativeAccessSpecifierPrivate
		TMap<struct FGuid, struct FGuid>                           TransformIdMap;                                          // 0x00F0(0x0050) NativeAccessSpecifierPrivate
	};
	...
	public:
		...
		unsigned char                                              UnknownData_JM4H[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_069W[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_D3TZ[0x4];                                   // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZN0Y[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_PP7X[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_06YQ[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
