...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4GN8[0x2];                                   // 0x009E(0x0002) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6EG8[0x18];                                  // 0x00F8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1MPV[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7NVD[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_AN8Z[0x5];                                   // 0x004B(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TD2H[0x48];                                  // 0x02B0(0x0048) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SEUP[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VQW7[0x3];                                   // 0x0035(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_3FN1[0x4];                                   // 0x009C(0x0004) MISSED OFFSET (PADDING)
