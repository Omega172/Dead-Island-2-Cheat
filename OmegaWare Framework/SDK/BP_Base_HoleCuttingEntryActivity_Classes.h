...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FOXH[0x7];                                   // 0x0819(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XE1U[0x2];                                   // 0x083E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
