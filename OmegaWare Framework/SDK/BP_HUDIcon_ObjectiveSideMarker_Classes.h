...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_HUDIcon_ObjectiveSideMarker.BP_HUDIcon_ObjectiveSideMarker_C
	 * Size -> 0x0010 (FullSize[0x03C0] - InheritedSize[0x03B0])
	 */
	class UBP_HUDIcon_ObjectiveSideMarker_C : public UHUDIconObjective
	{
	public:
	...
	public:
		...
		void LongHover();
		void ExecuteUbergraph_BP_HUDIcon_ObjectiveSideMarker(int32_t EntryPoint);
