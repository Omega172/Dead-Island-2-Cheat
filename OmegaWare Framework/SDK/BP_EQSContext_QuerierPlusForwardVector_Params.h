...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_QuerierPlusForwardVector.BP_EQSContext_QuerierPlusForwardVector_C.ProvideSingleLocation
	 */
	struct UBP_EQSContext_QuerierPlusForwardVector_C_ProvideSingleLocation_Params
	{
	public:
