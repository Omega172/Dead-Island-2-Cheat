...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Projectile_Spit_Player.BP_Projectile_Spit_Player_C
	 * Size -> 0x001C (FullSize[0x05CC] - InheritedSize[0x05B0])
	 */
	class ABP_Projectile_Spit_Player_C : public AModularProjectileActor
	{
	public:
		...
		unsigned char                                              UnknownData_RIIY[0x3];                                   // 0x05C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
