...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_MeleeWeapon_FuryFists.BP_MeleeWeapon_FuryFists_C
	 * Size -> 0x0010 (FullSize[0x0300] - InheritedSize[0x02F0])
	 */
	class ABP_MeleeWeapon_FuryFists_C : public ABP_Base_MeleeWeapon_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_MeleeWeapon_FuryFists(int32_t EntryPoint);
