...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_HuntingRifle.ABP_HuntingRifle_C
	 * Size -> 0x0090 (FullSize[0x0C60] - InheritedSize[0x0BD0])
	 */
	class UABP_HuntingRifle_C : public UDIWeaponAnimInstance
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_ABP_HuntingRifle(int32_t EntryPoint);
