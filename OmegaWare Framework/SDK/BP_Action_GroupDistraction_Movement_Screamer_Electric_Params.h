...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Action_GroupDistraction_Movement_Screamer_Electric.BP_Action_GroupDistraction_Movement_Screamer_Electric_C.GetMoveTargetDirection
	 */
	struct UBP_Action_GroupDistraction_Movement_Screamer_Electric_C_GetMoveTargetDirection_Params
	{
	public:
