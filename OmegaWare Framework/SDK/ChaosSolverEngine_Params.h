...
namespace CG
{
	...
	public:
		...
		struct FHitResult                                          ReturnValue;                                             // 0x0070(0x00B0)  (Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	};
