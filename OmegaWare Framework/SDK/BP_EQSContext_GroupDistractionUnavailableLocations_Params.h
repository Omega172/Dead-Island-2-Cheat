...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_GroupDistractionUnavailableLocations.BP_EQSContext_GroupDistractionUnavailableLocations_C.ProvideLocationsSet
	 */
	struct UBP_EQSContext_GroupDistractionUnavailableLocations_C_ProvideLocationsSet_Params
	{
	public:
