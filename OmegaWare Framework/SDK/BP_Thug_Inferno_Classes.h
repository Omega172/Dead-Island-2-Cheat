...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Thug_Inferno.BP_Thug_Inferno_C
	 * Size -> 0x0018 (FullSize[0x10C0] - InheritedSize[0x10A8])
	 */
	class ABP_Thug_Inferno_C : public ABP_Base_Thug_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Thug_Inferno(int32_t EntryPoint);
