...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QWRW[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		struct FPointImpactEventRequest                            Request;                                                 // 0x0028(0x0308)  (Parm, OutParm, ContainsInstancedReference)
	};
