...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Projectile_Spit_Slobber_Firestorm.BP_Projectile_Spit_Slobber_Firestorm_C
	 * Size -> 0x0050 (FullSize[0x0600] - InheritedSize[0x05B0])
	 */
	class ABP_Projectile_Spit_Slobber_Firestorm_C : public AModularProjectileActor
	{
	public:
		...
		unsigned char                                              UnknownData_XMRR[0x3];                                   // 0x05C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7YV0[0x4];                                   // 0x05D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_Projectile_Spit_Slobber_Firestorm(int32_t EntryPoint);
