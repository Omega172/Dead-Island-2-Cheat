...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_Revolver.ABP_Revolver_C
	 * Size -> 0x0090 (FullSize[0x0C60] - InheritedSize[0x0BD0])
	 */
	class UABP_Revolver_C : public UDIWeaponAnimInstance
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_ABP_Revolver(int32_t EntryPoint);
