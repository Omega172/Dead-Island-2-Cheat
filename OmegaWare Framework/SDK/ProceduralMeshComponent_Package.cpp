...
namespace CG
{
	 ...
	 * 		bool                                               bClipCollision                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	EProcMeshSliceResult UKismetProceduralMeshLibrary::SliceProceduralMesh(class UProceduralMeshComponent* InProcMesh, const struct FVector& PlanePosition, const struct FVector& PlaneNormal, bool bCreateOtherHalf, class UProceduralMeshComponent** OutOtherHalfProcMesh, EProcMeshSliceCapOption CapOption, class UMaterialInterface* CapMaterial, bool bClipCollision)
	{
		...
		params.bClipCollision = bClipCollision;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function ProceduralMeshComponent.KismetProceduralMeshLibrary.FlushProceduralMeshDeferredCollisions
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UProceduralMeshComponent*                    InProcMesh                                                 (Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		class UStaticMesh*                                 InStaticMesh                                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void UKismetProceduralMeshLibrary::FlushProceduralMeshDeferredCollisions(class UProceduralMeshComponent* InProcMesh, class UStaticMesh* InStaticMesh)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ProceduralMeshComponent.KismetProceduralMeshLibrary.FlushProceduralMeshDeferredCollisions");
		
		UKismetProceduralMeshLibrary_FlushProceduralMeshDeferredCollisions_Params params {};
		params.InProcMesh = InProcMesh;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function ProceduralMeshComponent.KismetProceduralMeshLibrary.CopyProceduralMeshFromStaticMesh
	 * 		Flags  -> ()
	 * Parameters:
	 ...
	 * 		class UProceduralMeshComponent*                    ProcMeshComponent                                          (Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		bool                                               bCreateCollision                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FTransform                                  UVTransform                                                (ConstParm, Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	void UKismetProceduralMeshLibrary::CopyProceduralMeshFromStaticMesh(class UStaticMesh* StaticMesh, int32_t LODIndex, class UProceduralMeshComponent* ProcMeshComponent, bool bCreateCollision, const struct FTransform& UVTransform)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ProceduralMeshComponent.KismetProceduralMeshLibrary.CopyProceduralMeshFromStaticMesh");
		
		UKismetProceduralMeshLibrary_CopyProceduralMeshFromStaticMesh_Params params {};
