...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_8KFL[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZUOC[0x10];                                  // 0x0020(0x0010) MISSED OFFSET (PADDING)
	};
