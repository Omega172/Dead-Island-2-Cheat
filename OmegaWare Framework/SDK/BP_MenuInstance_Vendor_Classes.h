...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_MenuInstance_Vendor.BP_MenuInstance_Vendor_C
	 * Size -> 0x0030 (FullSize[0x0378] - InheritedSize[0x0348])
	 */
	class UBP_MenuInstance_Vendor_C : public UMenuInstancePlayerMenu
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_MenuInstance_Vendor(int32_t EntryPoint);
