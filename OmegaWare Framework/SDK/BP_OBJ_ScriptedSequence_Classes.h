...
namespace CG
{
	...
	public:
		...
		class UScriptedSequenceComponent*                          ScriptedSequence;                                        // 0x0368(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, PersistentInstance, HasGetValueTypeHash
