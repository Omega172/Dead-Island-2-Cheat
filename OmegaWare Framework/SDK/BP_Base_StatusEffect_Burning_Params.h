...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Base_StatusEffect_Burning.BP_Base_StatusEffect_Burning_C.ReceiveBeginInstance
	 */
	struct UBP_Base_StatusEffect_Burning_C_ReceiveBeginInstance_Params
	{
	public:
	...
	/**
	 * Function BP_Base_StatusEffect_Burning.BP_Base_StatusEffect_Burning_C.ReceiveEnd
	 */
	struct UBP_Base_StatusEffect_Burning_C_ReceiveEnd_Params
	{
	public:
		class UStatusEffectComponent*                              Component;                                               // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		class UStatusEffectTypeState*                              TypeState;                                               // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BP_Base_StatusEffect_Burning.BP_Base_StatusEffect_Burning_C.ReceiveBegin
	 */
	struct UBP_Base_StatusEffect_Burning_C_ReceiveBegin_Params
	{
	public:
		class UStatusEffectComponent*                              Component;                                               // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		class UStatusEffectTypeState*                              TypeState;                                               // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
