...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageSectionChanged
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UAnimMontage*                                Montage                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		EMontageSectionEventType                           EventType                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		class FName                                        SectionName                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void UPlayMontageCallbackProxy::OnMontageSectionChanged(class UAnimMontage* Montage, EMontageSectionEventType EventType, const class FName& SectionName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageSectionChanged");
		
		UPlayMontageCallbackProxy_OnMontageSectionChanged_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function AnimGraphRuntime.PlayMontageCallbackProxy.Activate
	 * 		Flags  -> ()
	 */
	void UPlayMontageCallbackProxy::Activate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnimGraphRuntime.PlayMontageCallbackProxy.Activate");
		
		UPlayMontageCallbackProxy_Activate_Params params {};
