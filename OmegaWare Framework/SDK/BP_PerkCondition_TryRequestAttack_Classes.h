...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_PerkCondition_TryRequestAttack.BP_PerkCondition_TryRequestAttack_C
	 * Size -> 0x0008 (FullSize[0x0068] - InheritedSize[0x0060])
	 */
	class UBP_PerkCondition_TryRequestAttack_C : public UPerkCondition
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_PerkCondition_TryRequestAttack(int32_t EntryPoint);
