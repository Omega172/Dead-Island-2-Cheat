...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_DistractionInstigator.BP_EQSContext_DistractionInstigator_C.ProvideSingleActor
	 */
	struct UBP_EQSContext_DistractionInstigator_C_ProvideSingleActor_Params
	{
	public:
