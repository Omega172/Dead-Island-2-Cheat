...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_Controlled_SearchLocation.BP_EQSContext_Controlled_SearchLocation_C.ProvideLocationsSet
	 */
	struct UBP_EQSContext_Controlled_SearchLocation_C_ProvideLocationsSet_Params
	{
	public:
