...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_SportingRifle.ABP_SportingRifle_C
	 * Size -> 0x0090 (FullSize[0x0C60] - InheritedSize[0x0BD0])
	 */
	class UABP_SportingRifle_C : public UDIWeaponAnimInstance
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_ABP_SportingRifle(int32_t EntryPoint);
