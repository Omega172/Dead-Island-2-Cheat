...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LQ89[0x1];                                   // 0x00EB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MBZX[0x48];                                  // 0x0128(0x0048) MISSED OFFSET (PADDING)
