...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CPT6[0x8];                                   // 0x0058(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OWZE[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
