...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_PerkCondition_PlayerSwappedWeapon.BP_PerkCondition_PlayerSwappedWeapon_C
	 * Size -> 0x0008 (FullSize[0x0060] - InheritedSize[0x0058])
	 */
	class UBP_PerkCondition_PlayerSwappedWeapon_C : public UPerkCondition
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_PerkCondition_PlayerSwappedWeapon(int32_t EntryPoint);
