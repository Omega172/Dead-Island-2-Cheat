...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_AllGoalParticipantDistractions.BP_EQSContext_AllGoalParticipantDistractions_C.ProvideLocationsSet
	 */
	struct UBP_EQSContext_AllGoalParticipantDistractions_C_ProvideLocationsSet_Params
	{
	public:
