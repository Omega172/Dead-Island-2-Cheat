...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_PerkCondition_PlayerSwappedWeapon_Data.BP_PerkCondition_PlayerSwappedWeapon_Data_C
	 * Size -> 0x0010 (FullSize[0x0048] - InheritedSize[0x0038])
	 */
	class UBP_PerkCondition_PlayerSwappedWeapon_Data_C : public UConditionCustomDataBase
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_PerkCondition_PlayerSwappedWeapon_Data(int32_t EntryPoint);
