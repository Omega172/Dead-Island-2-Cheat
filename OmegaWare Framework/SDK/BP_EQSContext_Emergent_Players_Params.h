...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_Emergent_Players.BP_EQSContext_Emergent_Players_C.ProvideActorsSet
	 */
	struct UBP_EQSContext_Emergent_Players_C_ProvideActorsSet_Params
	{
	public:
