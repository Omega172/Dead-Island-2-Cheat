...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * UserDefinedStruct SCustomHazardStimParams.SCustomHazardStimParams
	 * Size -> 0x0010
	 */
	struct FSCustomHazardStimParams
	{
	public:
		EHazardStimTypes                                           StimType_107_7A8DDA00421FC65BF20DCFB3420780FE;           // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_JN1L[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
