...
{
    if (oPresent.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oPresent hook!");
    if (oPresent1.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oPresent1 hook!");
    if (oResizeBuffers1.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oResizeBuffers1 hook!");
    if (oCreateSwapChain.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oCreateSwapChain hook!");
    if (oCreateSwapChainForHwnd.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oCreateSwapChainForHwnd hook!");
    if (oCreateSwapChainForCoreWindow.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oCreateSwapChainForCoreWindow hook!");
    if (oCreateSwapChainForComposition.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oCreateSwapChainForComposition hook!");
    if (oExecuteCommandLists.RemoveHook() != MH_OK)
        LogErrorHere("Failed to remove oExecuteCommandLists hook!");
