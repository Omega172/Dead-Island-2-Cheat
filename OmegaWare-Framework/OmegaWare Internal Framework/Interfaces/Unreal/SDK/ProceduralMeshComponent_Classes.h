...
namespace CG
{
	...
	{
	public:
		EProcMeshSliceResult SliceProceduralMesh(class UProceduralMeshComponent* InProcMesh, const struct FVector& PlanePosition, const struct FVector& PlaneNormal, bool bCreateOtherHalf, class UProceduralMeshComponent** OutOtherHalfProcMesh, EProcMeshSliceCapOption CapOption, class UMaterialInterface* CapMaterial, bool bClipCollision);
		...
		void FlushProceduralMeshDeferredCollisions(class UProceduralMeshComponent* InProcMesh, class UStaticMesh* InStaticMesh);
		...
		void CopyProceduralMeshFromStaticMesh(class UStaticMesh* StaticMesh, int32_t LODIndex, class UProceduralMeshComponent* ProcMeshComponent, bool bCreateCollision, const struct FTransform& UVTransform);
	 ...
	 * Size -> 0x0088 (FullSize[0x05E0] - InheritedSize[0x0558])
	 */
	class UProceduralMeshComponent : public UMeshComponent
	{
	public:
		unsigned char                                              UnknownData_7XPW[0x8];                                   // 0x0558(0x0008) Fix Super Size
		...
		bool                                                       bDeferCollisionUpdates;                                  // 0x0562(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_6OM0[0x5];                                   // 0x0563(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UBodySetup*                                          ProcMeshBodySetup;                                       // 0x0568(0x0008) ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		struct FBoxSphereBounds                                    LocalBounds;                                             // 0x0590(0x001C) ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_1T2H[0x4];                                   // 0x05AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UBodySetup*>                                  AsyncBodySetupQueue;                                     // 0x05B0(0x0010) ZeroConstructor, Transient, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_KS0Q[0x20];                                  // 0x05C0(0x0020) MISSED OFFSET (PADDING)
