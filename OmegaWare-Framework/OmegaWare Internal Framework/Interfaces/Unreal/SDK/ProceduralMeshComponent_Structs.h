...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Enum ProceduralMeshComponent.EProcMeshSliceResult
	 */
	enum class EProcMeshSliceResult : uint8_t
	{
		NotClipped       = 0,
		PartiallyClipped = 1,
		FullyClipped     = 2,
	...
	public:
		...
		unsigned char                                              UnknownData_D8I8[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_2L8F[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (PADDING)
	};
