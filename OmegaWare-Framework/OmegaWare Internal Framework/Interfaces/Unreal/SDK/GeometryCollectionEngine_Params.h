...
namespace CG
{
	...
	public:
		...
		struct FHitResult                                          OutHit;                                                  // 0x0018(0x00B0)  (Parm, OutParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	...
	public:
		...
		unsigned char                                              UnknownData_9CK8[0x6];                                   // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
