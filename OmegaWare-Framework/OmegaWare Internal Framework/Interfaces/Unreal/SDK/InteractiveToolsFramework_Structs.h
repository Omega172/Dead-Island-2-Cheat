...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_F469[0xD8];                                  // 0x0000(0x00D8) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_4D3W[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_0YOV[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_OYRN[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
