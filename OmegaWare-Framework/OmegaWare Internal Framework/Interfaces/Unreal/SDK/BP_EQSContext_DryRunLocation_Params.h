...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_DryRunLocation.BP_EQSContext_DryRunLocation_C.ProvideLocationsSet
	 */
	struct UBP_EQSContext_DryRunLocation_C_ProvideLocationsSet_Params
	{
	public:
