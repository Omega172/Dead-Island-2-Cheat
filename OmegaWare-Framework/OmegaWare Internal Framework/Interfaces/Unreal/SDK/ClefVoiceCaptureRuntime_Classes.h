...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YXCR[0x1];                                   // 0x002B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MLJ2[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
