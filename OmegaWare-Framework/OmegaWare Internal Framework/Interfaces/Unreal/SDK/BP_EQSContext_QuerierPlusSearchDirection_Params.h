...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_EQSContext_QuerierPlusSearchDirection.BP_EQSContext_QuerierPlusSearchDirection_C.ProvideSingleLocation
	 */
	struct UBP_EQSContext_QuerierPlusSearchDirection_C_ProvideSingleLocation_Params
	{
	public:
