...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_MenuInstance_PlayerMenu.BP_MenuInstance_PlayerMenu_C
	 * Size -> 0x0030 (FullSize[0x0378] - InheritedSize[0x0348])
	 */
	class UBP_MenuInstance_PlayerMenu_C : public UMenuInstancePlayerMenu
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_MenuInstance_PlayerMenu(int32_t EntryPoint);
