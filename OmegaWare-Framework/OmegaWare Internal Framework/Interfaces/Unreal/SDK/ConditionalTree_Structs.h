...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_R5Y9[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HJMY[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
