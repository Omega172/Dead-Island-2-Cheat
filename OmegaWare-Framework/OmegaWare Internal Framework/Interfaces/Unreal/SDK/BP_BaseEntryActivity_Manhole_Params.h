...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_BaseEntryActivity_Manhole.BP_BaseEntryActivity_Manhole_C.ConstructBoundActors
	 */
	struct ABP_BaseEntryActivity_Manhole_C_ConstructBoundActors_Params
	{
	public:
